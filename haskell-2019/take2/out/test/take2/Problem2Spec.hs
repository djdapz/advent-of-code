...
--        (assertEqual
--           ":("
--           [1, 2, 6, 13, 2, 2, 3, 2, 1, 1, 12, 3, 99]
--           (intcodeCompile 0 [1, 1, 1, 1, 2, 2, 3, 2, 1, 1, 12, 3, 99]))
--    , testCase "shouldComplieList2" (assertEqual ":(" [1, 0, 0, 0, 99] (intcodeCompile 0 [2, 0, 0, 0, 99]))
--    ]
--
...
multiplyCommandTests =
  testGroup
    ...
    , testCase
        ...
        (assertEqual ":(" [1, 4, 4, 5, 2, 5, 7, 1] (multiplyCommand 1 [1, 2, 4, 5, 2, 5, 7, 1]))
    ]
